        ...
        <div key={i} className={`border rounded-xl overflow-hidden transition-all ${
          ...
          {selected === i && (
            <div className="px-4 pb-4 bg-gray-50 border-t border-gray-100 space-y-3">
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Your Answer</label>
...
const InterviewCoach = ({ resumeText = "" }) => {
      ...
      <div className="space-y-6 dark:text-gray-300">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Interview Type</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Question Bank Size</label>
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-bold text-gray-900 dark:text-white">🎤 Live Mock Interview — {role}</h3>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="font-bold text-gray-900 dark:text-white">📋 Question Bank — {role}</h3>
